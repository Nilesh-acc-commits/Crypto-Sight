    ...
    return (
        ...
        >
            <div className="flex items-center gap-4 mb-8">
                ...
                <h1 className="text-4xl font-bold text-white">Market Compare</h1>
            </div>
                    ...
                    <ResponsiveContainer width="100%" height="100%">
                        <LineChart data={chartData}>
                            ...
                            <Legend
                                ...
                                height={36}
                                iconType="circle"
                                wrapperStyle={{ top: -10, right: 0, textTransform: 'uppercase', fontSize: '12px', fontWeight: 'bold' }}
                            />
                            <ReferenceLine x={chartData.find(d => d.isForecast)?.time} stroke="#94a3b8" strokeDasharray="3 3" label={{ value: "FORECAST START", position: 'insideTopRight', fill: '#94a3b8', fontSize: 10 }} />
