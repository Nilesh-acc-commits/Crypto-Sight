        ...
        <div className="min-h-screen bg-[#0B0F19] relative overflow-hidden">
            ...
            >
                ...
                <div className="flex flex-col md:flex-row justify-between items-end mb-10 pt-4">
                    ...
                    >
                        <h1 className="text-5xl lg:text-7xl font-bold text-white mb-2 tracking-tighter leading-tight font-display overflow-visible px-4">
                            <span className="metallic-text inline-block overflow-visible" style={{ paddingRight: '10px' }}>Crypto</span>
                            <span className="neon-text inline-block overflow-visible text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-500">Sight</span>
                        </h1>
                        <p className="text-slate-400 text-lg px-4 font-light">AI-Powered Market Intelligence</p>
                    </motion.div>
